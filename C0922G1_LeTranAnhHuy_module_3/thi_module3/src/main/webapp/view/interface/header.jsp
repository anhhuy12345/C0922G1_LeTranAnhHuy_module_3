...
<div class="container-fluid row" style="background-color: #046056; margin: 0 auto;">
    ...
    <div class="col-md-3">
        <a style="font-family: 'Times New Roman';font-size: 100%;font-weight: bold;margin-left: 120px;color: #FEF6F0">Lê Trần Anh Huy
            C0922G1</a>
    </div>
</div>
<div class="mt-2 sticky row" style="background: #046056;margin-top: -0.5rem!important;">
    <nav class="navbar navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand text-light ps-5 click col-l-4" href="/book">Sach</a>
            <a class="navbar-brand text-light click col-l-4" href="">Nội Dung 2</a>
