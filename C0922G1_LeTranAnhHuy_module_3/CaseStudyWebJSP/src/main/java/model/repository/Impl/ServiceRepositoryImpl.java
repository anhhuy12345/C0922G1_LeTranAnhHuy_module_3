...
public class ServiceRepositoryImpl implements IServiceRepository {
    ...
    public boolean deleteService(int id) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(DELETE_SERVICE_SQL);) {
    ...
    public boolean updateService(Service service) {
        try (Connection connection = BaseRepository.getConnect();
             PreparedStatement ps = connection.prepareStatement(UPDATE_SERVICE_SQL);) {
            ps.setInt(1, service.getServiceTypeId());
